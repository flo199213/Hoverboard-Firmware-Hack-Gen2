...
#ifdef MASTER
// Usart steer defines
#define USART_STEER USART0
#define USART_STEER_TX_PIN GPIO_PIN_6
#define USART_STEER_TX_PORT GPIOB
#define USART_STEER_RX_PIN GPIO_PIN_7
#define USART_STEER_RX_PORT GPIOB
